...
from SpatialRegionTools import get_cell_id_center_coord_dict, makeVocab, inregionS, gps2cell
from spatial_grid_utils import get_region
...
def get_od_hot_cell(od_pairs, region, lower_bound):
    od_pair_num_dict = {}
    od_cell_set = set()
    hot_od_gps_set = set()
    for od in od_pairs:
...
if __name__ == '__main__':
    ...
    total_od_pairs = get_od_filter_by_day_and_hour(5, 12, 14, 8, 10, od_region)
    # print(total_od_pairs[0:3])
    od_pairs, od_cell_set, od_pair_set, hot_od_gps_set = get_od_hot_cell(total_od_pairs, od_region, 1)
    print(od_pair_set)